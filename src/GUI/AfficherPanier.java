...
public class AfficherPanier extends BaseForm{
 ...
 //user User = Session.getCurrentSession();
        ...
        java.util.List<Produit> product = ServiceProduit.getInstance().getMesProducts(User);
        ...
        InfiniteScrollAdapter.createInfiniteScroll(this.getContentPane(), () -> {
            ...
            for (Produit prod : product) {
                ...
                cmps[i].addActionListener(cliqueEvent -> {
                    ...
                    if (b) { 
                        Dialog.show("Achat", "Success", "OK", "");
                    } else {
                        Dialog.show("Achat", "Error", "OK", "");
                    }
            ...
            Button btnAdd = new Button("Procéder à l'achat");
            btnAdd.addActionListener(cliqueEvent -> {
                try {
                    boolean b = ServiceProduit.getInstance().ProceedWithChekout();
            ...
            add(FlowLayout.encloseIn(btnAdd));
